...
- Hot research topic
- Automatic Machine Learning is NOT Automatic Data Science. <b>To date</b>, there is no production level algorithm that can translate a business need expressed in natural language to an algorithm.
...
## Open Source (Not exhaustive)

- Auto sklearn, winner of the [ChaLearn AutoML challenge](http://automl.chalearn.org/) (Python)
- [TPOT](http://automl.info/tpot/) (Python). Based on Genetic Algorithms and the scikit-learn
- [AUTOWEKA](http://www.cs.ubc.ca/labs/beta/Projects/autoweka/)(Java/GUI)
- [A repository of autoML and related solutions](https://github.com/automl)

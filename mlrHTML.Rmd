...
- Extensible
- Calculate 38 meta-features on 140 datasets, about data characteristics: sample size, skewnewss, classes
- The distance of a new dataset to this 140 datasets will be measured
- The 25 closest used in a Bayesian Optimization to find the best instantiation
...
There are solutions that <b>claim</b> can convert data to personalised stories around that data in natural language. An example is: <b>https://narrativescience.com</b>
...
- H2O (also Python, Java and Scala)
- Caret 
- MLR
...
- Short for _C_lassification _A_nd _RE_gression _T_raining).
- Documented extensively: [book Applied Predictive Modelling](http://www.springer.com/gp/book/9781461468486), a [paper](https://www.jstatsoft.org/article/view/v028i05) and a [Datacamp training](https://www.datacamp.com/courses/machine-learning-toolbox).
...
I have mixed material from the [MLR package](https://cran.r-project.org/web/packages/mlr/index.html), its [Tutorials](https://mlr-org.github.io/mlr-tutorial/devel/html/) and also from [Blogs](https://www.analyticsvidhya.com/blog/2016/08/practicing-machine-learning-techniques-in-r-with-mlr-package/).

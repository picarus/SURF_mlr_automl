...
- Automatic Machine Learning is NOT Automatic Data Science, many tools advertise as Automating Data Science but they don't!!
...
- Extensible
- For each of 140 datasets (training set), 38 meta-features are calculated on data characteristics: sample size, skewnewss, classes, entropy, ...
